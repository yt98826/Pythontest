...
# 需求6: 小明把技术传给徒弟的同时, 不想把自己的私房钱继承给徒弟, 请用所学, 模拟该知识.


# 1.定义徒弟类
class Prentice(object):
    def __init__(self):
        self.kongfu = '[自研 摊煎饼技术]'
        self.__money = 6000
...
if __name__ == '__main__':
    ...
    # 5.尝试访问 父类（徒弟类）的私房钱money
    # print(f'看到了徒弟的私房钱: {tusun.money}')
    # print(f'看到了徒弟的私房钱: {tusun.__money}')
    print(f'看到了徒弟的私房钱: {tusun.get_money()}')

    tusun.set_money(85555)
    print(f'看到了徒弟的私房钱: {tusun.get_money()}')
